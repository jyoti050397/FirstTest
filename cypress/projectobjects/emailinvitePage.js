export default class EmailInvitePage {
  elements = {
    ...
    Fullmembers:()=> cy.get('.cu-tms-nav__item_active'),

    Externalguests:()=> cy.get('[data-test="team-users-settings-nav"] > :nth-child(2)'),

    Internalguests:()=>cy.get('[data-test="team-users-settings-nav"] > :nth-child(3)'),
    ...
    canceliToast:()=>cy.get('.toast__undo'),
...
//Click on "How to invite a guest"
 /*guideInvite()
 {
  this.elements.guidelink().click();
  //Captcha issue 
    ...
    this.elements.bannerEmail()
      ...
      .then(() => {
        ...
        this.elements.canceliToast()
          .should('contain', 'Invitation to sharmajojo799@gmail.com has been canceled from Tester\'s Workspace')
          .should('exist');
